...
int main() {
	...
	//MatrixMultiplicationXAxisWorkItems(hardware, "./kernel/matmul_xaxis_kernel.cl", "MatMulKernel");
	MatrixMultiplication(hardware, "./kernel/matmul_kernel.cl", "MatMulKernel");
